        ...
        <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b bg-card px-6">
            ...
            <div className="hidden md:flex flex-1 max-w-md">
                <div className="relative w-full">
                    ...
                    <Input
                        type="search"
                        placeholder="Ticket numarası veya kullanıcı ara..."
                    ...
                    <DropdownMenuContent align="end" className="w-80">
                        ...
                        <div className="space-y-2 p-2">
                            <div className="flex gap-3 p-2 rounded-lg hover:bg-accent cursor-pointer">
                                ...
                                <div>
                                    <p className="text-sm font-medium">Acil destek talebi</p>
                                    <p className="text-xs text-muted-foreground">TKT-2026-001234</p>
                                </div>
                            </div>
                            <div className="flex gap-3 p-2 rounded-lg hover:bg-accent cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Müşteri yanıtladı</p>
                                </div>
                            </div>
                            <div className="flex gap-3 p-2 rounded-lg hover:bg-accent cursor-pointer">
                                <div className="h-2 w-2 mt-2 rounded-full bg-orange-500 shrink-0" />
                                <div>
                                    <p className="text-sm font-medium">Atanmamış ticket</p>
                                    <p className="text-xs text-muted-foreground">5 talep bekliyor</p>
                                </div>
                            </div>
                        </div>
                    </DropdownMenuContent>
                    ...
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="relative h-9 w-9 rounded-full">
                            <Avatar className="h-9 w-9">
                                <AvatarImage src="/placeholder.svg" alt="Destek" />
                    ...
                    <DropdownMenuContent className="w-56" align="end">
                        <DropdownMenuLabel className="font-normal">
                            <div className="flex flex-col space-y-1">
                                <p className="text-sm font-medium leading-none">Destek Temsilcisi</p>
