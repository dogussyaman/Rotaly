            ...
            <div className="space-y-2 p-2">
              <div className="flex gap-3 p-2 rounded-lg hover:bg-accent cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Grand Resort - 2 gece</p>
                </div>
              </div>
              <div className="flex gap-3 p-2 rounded-lg hover:bg-accent cursor-pointer">
                <div className="h-2 w-2 mt-2 rounded-full bg-primary shrink-0" />
                <div>
                  <p className="text-sm font-medium">Destek talebi</p>
                  <p className="text-xs text-muted-foreground">Yeni mesaj var</p>
                </div>
              </div>
              <div className="flex gap-3 p-2 rounded-lg hover:bg-accent cursor-pointer">
                <div className="h-2 w-2 mt-2 rounded-full bg-orange-500 shrink-0" />
                <div>
                  <p className="text-sm font-medium">Onay bekleyen tesis</p>
                  <p className="text-xs text-muted-foreground">Beach Villa - Bodrum</p>
                </div>
              </div>
            </div>
          </DropdownMenuContent>
